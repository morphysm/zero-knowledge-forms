...
type Report struct {
	...
	EthAddress []byte `protobuf:"bytes,3,opt,name=ethAddress,proto3" json:"ethAddress,omitempty"`
...
func (x *Report) GetEthAddress() []byte {
	if x != nil {
		return x.EthAddress
	}
	return nil
...
var file_report_proto_rawDesc = []byte{
	...
	0x70, 0x62, 0x22, 0x7e, 0x0a, 0x06, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x1c, 0x0a, 0x09,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x12, 0x1e, 0x0a, 0x0a, 0x65, 0x74, 0x68, 0x41, 0x64, 0x64, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0a, 0x65, 0x74, 0x68, 0x41, 0x64, 0x64,
